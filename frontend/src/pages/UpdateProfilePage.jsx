import {
  ...
  export default function UpdateProfilePage() {
	...
	const [inputs, setInputs] = useState({
	  ...
	  relationshipStatus: user.relationshipStatus || "Single", // Initialize with current user's relationship status
	  gender: user.gender || "Other", // Initialize with current user's gender
	});
		  ...
		  >
			...
			<FormControl>
			  ...
			  <Input
				...
				onChange={(e) => setInputs({ ...inputs, relationshipStatus: e.target.value })}
				_placeholder={{ color: "gray.500" }}
				type="text"
			  />
			</FormControl>
